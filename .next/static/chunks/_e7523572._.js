...
function CommunityPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CommunityPage.useEffect": ()=>{
            const fetchGames = {
                "CommunityPage.useEffect.fetchGames": async ()=>{
                    try {
                        const snapshot = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDocs"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], "games"));
                        const data = snapshot.docs.map({
                            "CommunityPage.useEffect.fetchGames.data": (doc)=>({
                                    id: doc.id,
                                    ...doc.data()
                                })
                        }["CommunityPage.useEffect.fetchGames.data"]);
                        setGames(data);
            ...
            }["CommunityPage.useEffect.fetchGames"];
            fetchGames();
        }
    }["CommunityPage.useEffect"], []);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CommunityPage.useEffect": ()=>{
            ...
            const filtered = games.filter({
                "CommunityPage.useEffect.filtered": (g)=>g.title?.toLowerCase().includes(q) || g.description?.toLowerCase().includes(q)
            }["CommunityPage.useEffect.filtered"]);
...
_s(CommunityPage, "C6in2AYDsHkB08M23On+ebigjUQ=");
_c = CommunityPage;
var _c;
...
//# sourceMappingURL=_e7523572._.js.map