          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {filteredGames.map(game => (
              <Link key={game.id} href={`/games/${game.id}`}>
                <div className="bg-gray-800 rounded-lg overflow-hidden transition-transform duration-200 hover:scale-105 border-2 border-gray-700 hover:border-indigo-500 h-full flex flex-col">
